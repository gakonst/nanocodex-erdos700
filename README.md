...
This repository contains two complete Lean-checked proofs and the research
frontier for the remaining open part of
...
| --- | --- | --- | --- |
| (i) | **Complete solution** for both the maintained largest-prime formulation and the literal 1978 greatest-prime-power formulation | [Compiled proof](part-i-complete-solution.pdf) | [`lean-part1/`](lean-part1/README.md) |
...
counterexamples to methods, and the surviving Part (iii) bottleneck. Everything
...
1. Characterize the composite $n$ for which $f(n)=n/P(n)$, where $P(n)$ is
   ...
   prime-power component; Part (i) here proves both non-equivalent versions.
...
row. The historical $Q(n)$ theorem uses the same system with the necessary
...
Each completed part is an independent pinned Lake project:
...
```text
README.md                       this page
part-i-complete-solution.pdf    complete Part (i) proof
