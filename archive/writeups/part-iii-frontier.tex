...
\href{https://github.com/gakonst/nanocodex-erdos700/blob/main/map/part-3.md}
{\texttt{map/part-3.md}}.  The compact specialist handoff is
\href{https://github.com/gakonst/nanocodex-erdos700/blob/main/map/part-3-bottleneck.md}
{\texttt{map/part-3-bottleneck.md}}.  Persisted-run and session
