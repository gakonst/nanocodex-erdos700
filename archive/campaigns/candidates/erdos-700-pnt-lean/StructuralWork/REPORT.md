...
The final combined compile was launched after all constituent checks, but the
remote development host stopped accepting SSH connections during that command.
Thus the only unchecked item in this directory is the import/assembly surface
of `Combined.lean`; its mathematical dependencies were all independently
compiled.
